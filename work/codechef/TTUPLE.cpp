...
inline int Solve(){
    ...
    if(flag){
        ...
        if(vv.size() == 2 && vv[0] == vv[1]) return 1;
        if(vv.size() == 3 && vv[0] == vv[1] && vv[1] == vv[2]) return 1;
    }
    ...
    if(flag){
        ...
        if(vv[0] == vv[1] || vv[1] == vv[2]) return 2;
        if(1ll*vv[0]*vv[1] == vv[2]) return 2;
    }
